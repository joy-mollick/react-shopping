...
import { MdProductionQuantityLimits, MdOutlineFavoriteBorder, MdPending, MdDownloadDone } from 'react-icons/md';
...
function Orders() {
    ...
    function delete_item(id) {
        Toast("This item is removed your order list. ", (2000));
    ...
    return (
        ...
        >
            ...
            {!one_cart && !two_cart && !three_cart && <div style={{ display: 'flex', justifyContent: 'center' }}>

                <div style={{ borderRadius: '10px', color: 'white', backgroundColor: 'deepskyblue', padding: '15px', fontSize: '22px' }}>
                    There is no order  till yet !
                </div>
                    ...
                    {one_cart && <div style={{ padding: '10px' }}>
                        ...
                        <div style={{ padding: '8px', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.2), 0 3px 6px 0 rgba(0, 0, 0, 0.19)' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <div style={{ color: 'white', borderRadius: '5px', backgroundColor: 'green', padding: '5px' }}>
                        ...
                        <div style={{ padding: '8px', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.2), 0 3px 6px 0 rgba(0, 0, 0, 0.19)' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <div style={{ color: 'white', borderRadius: '5px', backgroundColor: 'green', padding: '5px' }}>
                                    ...
                                    <text style={{ marginLeft: '2px' }}>  On The Way  </text>
                        ...
                        <div style={{ padding: '8px', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.2), 0 3px 6px 0 rgba(0, 0, 0, 0.19)' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <div style={{ color: 'white', borderRadius: '5px', backgroundColor: 'green', padding: '5px' }}>
                                    ...
                                    <text style={{ marginBottom: '2px' }}>  Received  </text>
